...
plugins : [
        ...
        new ModuleFederationPlugin({
            name : 'container',
            remotes : {
                payments_list: 'payments_list@http://localhost:3002/remoteEntry.js',
                payments_add: 'payments_add@http://localhost:3001/remoteEntry.js',
                static_pages: 'static_pages@http://localhost:3003/remoteEntry.js'
            }
                }
        )
    ],
