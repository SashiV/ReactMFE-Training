...
};
{
    ...
    var trans2 = __assign(__assign({}, trans1_1), { amount: 3000 });
    console.log(trans2.amount);
    var description = trans2.description, date = trans2.date;
    console.log(date);
    var transactions_1 = [trans1_1, trans2];
    function newTransaction() {
        var totalAmount = document.getElementById('balance');
        var amt = document.getElementById('amount');
        var totAmt = document.getElementById('balance');
        totAmt.value += amt.value;
        var trans = __assign(__assign({}, trans1_1), { amount: Number(amt.value) });
        transactions_1.push(trans);
